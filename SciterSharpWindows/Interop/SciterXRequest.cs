...
namespace SciterSharp.Interop
{
	public static class SciterXRequest
	{
		...
		public struct ISciterRequestAPI
		{
			...
			public FPTR_RequestSetReceivedDataType		RequestSetReceivedDataType;
			public FPTR_RequestSetReceivedDataEncoding	RequestSetReceivedDataEncoding;

			public FPTR_RequestGetData					RequestGetData;
			public FPTR_RequestGetRequestor				RequestGetRequestor;
			...
			public delegate REQUEST_RESULT FPTR_RequestGetRequestor(IntPtr rq, IntPtr pElement);
		}
	}
}