...
namespace SciterSharp.Interop
{
	public static class SciterXDef
	{
		...
		public struct SCITER_CALLBACK_NOTIFICATION
		{
			...
			public IntPtr hwnd;  // HWINDOW of the window this callback was attached to.
		}
		...
		[StructLayout(LayoutKind.Sequential)]
		public struct SCN_KEYBOARD_REQUEST
		{
			public uint code;  /**< [in] = SC_KEYBOARD_REQUEST */
			public IntPtr hwnd;  /**< [in] HWINDOW of the window this callback was attached to.*/
			public IntPtr keyboardType;    /**< [in] see: https://developer.android.com/reference/android/widget/TextView#attr_android:inputType */
		}

		/**This structure is used by #SC_INVALIDATE_RECT notification.
		 *\copydoc SC_INVALIDATE_RECT **/
		[StructLayout(LayoutKind.Sequential)]
		public struct SCN_INVALIDATE_RECT
		{
			public uint code;   /**< [in] = SC_INVALIDATE_RECT */
			public IntPtr hwnd;   /**< [in] HWINDOW of the window this callback was attached to.*/
			public PInvokeUtils.RECT invalidRect;  /**< [in] cumulative invalid rect.*/
		}
		...
		*\copydoc SC_SET_CURSOR **/
		...
		[StructLayout(LayoutKind.Sequential)]
		public struct SCN_SET_CURSOR
		{
			public uint code;   // [in] = SC_SET_CURSOR
			public IntPtr hwnd;   // [in] HWINDOW of the window this callback was attached to.
			public uint cursorId;   // [in] #CURSOR_TYPE, if cursorUrl == NULL
			public IntPtr cursorUrl;    // LPCSTR - [in] cursor URL 
