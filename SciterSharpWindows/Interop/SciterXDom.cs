...
namespace SciterSharp.Interop
{
	public static class SciterXDom
	{
		...
		{
			SCDOM_OK = 0,  // function completed successfully
			SCDOM_INVALID_HWND = 1,  // invalid HWINDOW 
			SCDOM_INVALID_HANDLE = 2,  // invalid HELEMENT
			SCDOM_PASSIVE_HANDLE = 3,  // attempt to use HELEMENT which is not marked by #sciter_useElement()
